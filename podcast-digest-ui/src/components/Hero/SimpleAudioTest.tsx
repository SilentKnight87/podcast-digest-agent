      ...
      .then(response => {
        ...
        audioRef.current.addEventListener('error', (e) => {
          ...
          console.error('Audio error details:', {
            ...
            networkStateText: ['NETWORK_EMPTY', 'NETWORK_IDLE', 'NETWORK_LOADING', 'NETWORK_NO_SOURCE'][audio.networkState],
  ...
  return (
    <div className="p-4 border rounded space-y-2">
      ...
      <div className="space-x-2">
        <Button onClick={createAndPlayAudio} size="sm">Create Audio</Button>
        <Button onClick={playAudio} size="sm">Play</Button>
      </div>
