    ...
    <header className="sticky top-0 z-50 w-full border-b border-border/40 bg-background/50 backdrop-blur-md">
      <div className="flex h-16 items-center px-8 w-full">
        ...
        <div className="ml-auto flex items-center gap-4">
          <Link href="https://github.com/SilentKnight87" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-foreground transition-colors">
