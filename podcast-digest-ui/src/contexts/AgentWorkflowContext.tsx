  ...
  switch (action.type) {
    ...
    case 'UPDATE_FROM_API_RESPONSE':
      ...
      const processingStatus: ProcessingStatus = {
        ...
        startTime: apiData.processing_status.start_time || state.processingStatus.startTime,
...
export const AgentWorkflowProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  return (
    <AgentWorkflowContext.Provider value={{ state, dispatch, startProcessing, isProcessing }}>
      {children}
