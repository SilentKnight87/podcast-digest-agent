...
class Settings(BaseSettings):
    ...
    # Webshare Proxy
    WEBSHARE_API_TOKEN: str | None = Field(default=None, env="WEBSHARE_API_TOKEN")
    WEBSHARE_PROXY_USERNAME: str | None = Field(default=None, env="WEBSHARE_PROXY_USERNAME")
    WEBSHARE_PROXY_PASSWORD: str | None = Field(default=None, env="WEBSHARE_PROXY_PASSWORD")

    # Generic Proxy Support
    GENERIC_PROXY_HTTP_URL: str | None = Field(default=None, env="GENERIC_PROXY_HTTP_URL")
    GENERIC_PROXY_HTTPS_URL: str | None = Field(default=None, env="GENERIC_PROXY_HTTPS_URL")
