...
def test_process_url_response_valid():
    ...
    data = {"task_id": "task-123", "status": "queued", "video_details": video_data}
...
def test_agent_node_valid():
    data = {
        ...
        "icon": "FileText",
        "logs": [
            {"timestamp": "2023-01-01T12:00:00Z", "level": "INFO", "message": "Agent started"}
        ],
    }
...
def test_audio_output_valid():
    data = {"url": "/audio/digest-123.mp3", "duration": "00:05:30", "file_size": "5.2MB"}
