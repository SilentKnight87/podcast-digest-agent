...
async def get_audio_file(filename: str):
    ...
    logger.info(f"File format detection: is_wav={is_wav}, is_mp3={is_mp3}, header_hex={header.hex()}")
    ...
    if is_wav:
        ...
        logger.warning(f"Unable to determine audio type for {filename}, falling back to octet-stream")
