  ...
  const steps = [
    {
      ...
      description:
        "Provide a YouTube video URL to begin the digest creation process.",
    },
    {
      icon: FileText,
      title: "Transcribe Audio",
      description:
        "The audio from the video is accurately transcribed into text.",
    },
    {
      icon: Cpu,
      title: "Summarize Content",
      description:
        "AI analyzes the transcript to extract key insights and main points.",
    },
    {
      icon: Mic,
      title: "Generate Audio Digest",
      description:
        "The summary is converted into a high-quality audio digest using Text-to-Speech.",
    },
    {
      icon: PlayCircle,
      title: "Access Your Digest",
      description:
        "Listen to your generated audio digest and view the text summary.",
    },
  ];
        ...
        <div className="rounded-xl border border-border/40 bg-card/70 backdrop-blur-md p-8 shadow-sm">
          <div className="mb-12 space-y-4 text-center">
            ...
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Our AI-powered process transforms YouTube videos into digestible
              podcast content in just a few steps.
            </p>
          </div>
