...
export function HeroSection() {
  ...
  console.log("[HeroSection] Decision factors:", {
    ...
    dataFlows: workflowState?.dataFlows?.map(
        ...
        <div className="flex flex-col items-center space-y-10 text-center">
          <div className="space-y-6 max-w-4xl">
            ...
            <p className="mx-auto max-w-[700px] text-muted-foreground text-lg md:text-xl">
              Enter a YouTube URL and get a concise AI-powered audio digest with
              natural voice narration. Perfect for those who want to consume the
              highlights from content on the go.
            </p>
          </div>
          ...
          <div className="w-full max-w-lg space-y-4">
            <form
              ...
              className="flex flex-col sm:flex-row w-full items-center space-y-3 sm:space-y-0 sm:space-x-3"
            >
            ...
            <div className="mt-12 w-full max-w-3xl mx-auto min-h-[300px] flex items-center justify-center">
              {showProcessingVisualizer && (
                <ProcessingVisualizer
                  ...
                  dataFlows={workflowState?.dataFlows}
                />
              )}
              {showPlayButton && (
                <div className="w-full">
                  {console.log(
                    "[HeroSection] Passing audioUrl to PlayDigestButton:",
              ...
              {showWaveform && (
                <Waveform
                  isProcessing={isProcessing && processingStatus !== "idle"}
                />
              )}
              ...
              {processingStatus === "failed" && (
                <div className="p-4 border border-destructive bg-destructive/10 rounded-md text-destructive">
                  <p>
                    Processing failed. Please try again with a different URL.
                  </p>
                </div>
              )}
            </div>
