import { Github, Heart, Headphones, Linkedin } from "lucide-react";
      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex flex-col md:flex-row md:justify-between items-start gap-8">
          <div className="flex flex-col md:flex-row items-start gap-8 md:gap-12">
            <div className="space-y-4">
              ...
              <p className="text-sm text-muted-foreground">
                Transform YouTube videos into concise, insightful podcast
                digests using AI.
              </p>
            </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-4">
              ...
              <a
                href="https://www.linkedin.com/in/peter-brown1990/"
                target="_blank"
                rel="noreferrer"
                className="rounded-full p-2 text-muted-foreground hover:text-foreground hover:bg-accent/10 transition-colors"
                aria-label="LinkedIn"
        ...
        <div className="flex flex-col items-center justify-between gap-4 mt-12 pt-6 border-t border-border/20 md:flex-row">
          <p className="text-center text-sm text-muted-foreground md:text-left">
            &copy; {new Date().getFullYear()} Podcast Digest. All rights
            reserved.
          </p>
          <p className="text-sm text-muted-foreground flex items-center">
            Made with <Heart className="h-3 w-3 text-error mx-1" /> using
            Next.js & shadcn/ui
          </p>
        </div>
      </div>
